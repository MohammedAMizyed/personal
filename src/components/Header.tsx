...
export default function Header() {
  ...
  return (
    <div className="container fixed top-0 z-20 bg-wight backdrop-blur-lg border-t-1 border-b-[1px] border-[#0000001a]">
      <div className=" relative z-10 h-16 mt-2  flex justify-between items-center">
        ...
        <div className="flex justify-center items-center gap-3">
          {links.map((link) => {
            return (
              <div
                className="text-[17px] p-2 hover:text-black cursor-pointer duration-200 text-[#717182b9]"
                key={link.id}
              >
                {link.title}
              </div>
        ...
        >
          <div className="bg-[#d0d0d0db] rounded-2xl p-2 text-[#030213] flex justify-center items-center gap-3 px-5 ">
            <RiUserStarLine />
